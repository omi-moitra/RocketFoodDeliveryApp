...
- `docVault/REFACTORING_AUDIT.md` contains point-in-time candidate findings, while `docVault/REFACTORING_IMPLEMENTATION_RECORD.md` is the canonical append-only history of completed refactors.
...
- Other documentation locations retain the organization established by the UI branch unless a user-selected option changes it.
